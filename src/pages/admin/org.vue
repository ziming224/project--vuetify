    ...
    <v-form :disabled="isSubmitting" @submit.prevent="submit">
      <v-card>
        ...
        <v-card-text>
          ...
          />
          <v-text-field
            v-model.number="phone.value.value"
            :error-messages="phone.errorMessage.value"
            label="電話"
          />
          <v-text-field
            v-model.number="mail.value.value"
            :error-messages="mail.errorMessage.value"
            label="電子信箱"
          />
          <v-text-field
            v-model.number="fb.value.value"
            :error-messages="fb.errorMessage.value"
            label="Facebook網站"
          />
          <v-text-field
            v-model.number="website.value.value"
            :error-messages="website.errorMessage.value"
            label="官方網站"
          />
          <v-text-field
            v-model.number="openingHours.value.value"
